README FOR THE NISO JATS 1.2d1 COMMITTEE DRAFT 
JOURNAL PUBLISHING DTD

(Publishing (Blue) Version DRAFT NISO JATS 1.2d1 July 2017)

                     Release Date: June v1.2d1 20170631//EN"
...
This README describes:
   ...
   2.0 Modules Needed for each DTD
       2.1 Modules Used in Publishing XHTML MathML 2.0 DTD
       2.2 Modules Used in Publishing XHTML MathML 3.0 DTD
       2.3 Modules Used in Publishing XHTML and OASIS CALS
             Tables with MathML 2.0 DTD
       2.4 Modules Used in Publishing XHTML and OASIS CALS
             Tables with MathML 3.0 DTD
       2.5 JATS Base Modules (used by all the Publishing DTDs)
   3.0 Descriptions of All Modules
       3.1  Modules Specific to the Publishing DTDs
...
2.1 Modules Used in the Publishing XHTML MathML 2.0 DTD
...
2.2  Modules Used in the Publishing XHTML MathML 3.0 DTD
...
2.3  Modules Used in the Publishing XHTML and OASIS CALS
      Tables with MathML 2.0 DTD
...
2.4  Modules Used in the Publishing XHTML and OASIS CALS
      Tables with MathML 3.0 DTD
...
2.5.3 NISO Access and Indicator Files
 - JATS-ali-namespace1.ent   

2.5.4 Notations and Special Characters
...
------------------------------------------------------
3.5 JATS Base Modules: Modules for MathML 2.0 and MathML 3.0 
    (Define MathML tagging, used in %math.ent;)

3.5.1 Modules for MathML 2.0
...
catalog-jats-v1-2d1-no-base.xml
...
catalog-jats-v1-2d1-with-base.xml
               - XML catalog made according to the
                 OASIS DTD Entity Resolution XML Catalog V2.1
"http://www.oasis-open.org/committees/entity/release/1.0/catalog.dtd"
