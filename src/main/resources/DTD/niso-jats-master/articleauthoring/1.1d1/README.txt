...
(Authoring (Pumpkin) Version DRAFT NISO JATS 1.1d1 November 2013)
...
Both files represent different versions of the Main DTD for the 
ANSI/NISO Article Authoring DTD. This is the DOCTYPE that covers 
a journal article and various other non-article journal content 
such as book and product reviews, as viewed by a single author 
...
Suite. An institution should choose a DTD based on MathML 
requirements. 
...
3.3.3 Notations and Special Characters
...
JATS-articleauthcustom-classes1.ent
             - Class customizations for the Authoring XHTML 
               ...
               for the for the Authoring DTDs. Used to over-ride 
...
JATS-common-atts1.ent
               Defines attributes intended to be used on ALL 
               elements defined in the NISO JATS, including 
               table elements for the XHTML-inspired table 
               model, with the exception of <mml:math> and 
